...
PRESETS = {
    "거래량 급증": {"universe": {"kinds": ["stock", "etf"], "markets": ["KOSPI", "KOSDAQ"], "exclude_preferred": True, "exclude_spac": True, "exclude_halted": True, "min_bars": 250}, "formula": "volume_ratio(volume, 20) >= 3 and value >= 5000000000 and close >= 1000", "sort": {"formula": "volume_ratio(volume, 20)", "dir": "desc"}, "limit": 500},
