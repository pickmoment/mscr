  ...
  return <div className="page page--fill">
    ...
    <div className="indicator-layout">
      <section className="panel indicator-editor">
        ...
        <div className="help-box"><b>정의</b> close / sma(close, period) - 1<br /><b>호출</b> ma_gap(20) &gt; 0.1<br /><b>함수</b> sma, ema, rsi, returns, prior_avg_ratio, obv, obv_ratio, historical_volatility, atr, slope, rolling_max, rolling_min, crosses_above, crosses_below, abs</div>
      </section>
